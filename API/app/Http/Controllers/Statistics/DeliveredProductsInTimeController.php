...
class DeliveredProductsInTimeController extends Controller
{
    ...
    public function __invoke(Request $request)
    {
        ...
        return Resource::make($this->statisticsRepository->getDeliveredProductsByCustomerTimeline($period));
    }
